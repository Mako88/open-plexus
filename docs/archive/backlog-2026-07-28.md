...
> Open work is in [DECISIONS.md](../../DECISIONS.md), and an option's history is in
> [docs/options/](../options/).
>
> *This header pointed at `STATE.md` until 2026-07-30. That file was replaced by the
> option tree on 2026-07-29 and the pointer was never updated — a dangling reference at
> the top of an archive, which is the failure the archive headers exist to prevent.
> Found by a check written over every file in this directory rather than one of them.*
