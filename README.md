...
- ❌ ~~Refuel a broadcast route on SURPRISE rather than strength~~ — *no signal: 0.1061, 0.1075, 0.1044 across a hundredfold budget range against a chance of 0.108, where strength's best is 0.1167. One seed, consistent with every earlier broadcast measurement.* **Revives if** surprise means a priori unlikeliness rather than low conditional probability.
